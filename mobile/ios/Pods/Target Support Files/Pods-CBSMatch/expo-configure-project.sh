...
with_node \
  ...
  --target "/Users/thomascline/Desktop/cbs-match/mobile/ios/Pods/Target Support Files/Pods-CBSMatch/ExpoModulesProvider.swift" \
  --entitlement "/Users/thomascline/Desktop/cbs-match/mobile/ios/CBSMatch/CBSMatch.entitlements" \
  --platform "apple" \
  --packages "expo" "expo-application" "expo-asset" "expo-constants" "expo-crypto" "expo-file-system" "expo-font" "expo-haptics" "expo-image-picker" "expo-keep-awake" "expo-secure-store"
